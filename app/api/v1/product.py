...
@inject
async def create_product(product: ProductCreate, service: FromDishka[ProductService]):
...
async def update_product(
    product_id: int, product: ProductUpdate, service: FromDishka[ProductService]
):
...
@inject
async def delete_product(product_id: int, service: FromDishka[ProductService]):
